cd(@__DIR__)
# /!\ change in the last lines as well!

# name_sim = "setting_2_mu_01_M=7_hetero_2_trait_comp_exp"
# name_sim = "setting_2_mu_01_M=7_hetero_2_illustrative_graphs"
# date_sim = "2022-02-26"

name_sim = "setting_2_mu_01_M\\=7_hetero_2_\\[-onehalf,onehalf\\]"
# date_sim = "2022-02-26" # t=3000
# date_sim = "2022-02-18" # t=2000
date_sim = "2022-01-13" # t=1000
...
vars_nostat = ["m", "μ", "D", "graph", "rθ", "soptim"]
