...
@load "../../../code/simulations/setting_2/M=7/setting_2_mu_01_M=7_stargraph/setting_2_mu_01_M=7_stargraph_2022-01-18_aggreg.jld2" df_aggreg

@load "explo_m_PDE_setting2/explo_m_PDE_setting2_2022-01-18.jld2" df_explo
...
ax[1].errorbar(df_toplot_ABM.m,
        df_toplot_ABM.Q_TS_s_mean,
        yerr = df_toplot_ABM.Q_TS_s_std,
...
ax[1].plot(df_toplot_PDE.m,
        ...
        # fmt = "o",
        ms = 4.)
        ax[1].set_xlabel(L"m"); ax[1].set_ylabel(L"Q_{ST,s}");
gcf()
...
fig.tight_layout()
fig.savefig("pde-vs-IBM-mresponse-setting2.pdf",
        dpi=1200,
        bbox_inches = "tight",)
gcf()
